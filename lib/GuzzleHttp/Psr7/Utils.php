...
namespace Splintr\PhpSdkLib\GuzzleHttp\Psr7;

use Splintr\PhpSdkLib\Psr\Http\Message\RequestInterface;
use Splintr\PhpSdkLib\Psr\Http\Message\ServerRequestInterface;
...
final class Utils
{
     ...
     * - `Splintr\PhpSdkLib\Psr\Http\Message\StreamInterface`: Returns the value as-is.
