...
namespace Splintr\PhpSdk\Dependencies\Symfony\Polyfill\Intl\Idn;

use Exception;
use SplintrPhpSdk_Normalizer;
use Splintr\PhpSdk\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\DisallowedRanges;
use Splintr\PhpSdk\Dependencies\Symfony\Polyfill\Intl\Idn\Resources\unidata\Regex;
...
final class Idn
{
    ...
    private static function process($domain, array $options, Info $info)
    {
        ...
        if (!SplintrPhpSdk_Normalizer::isNormalized($domain, SplintrPhpSdk_Normalizer::FORM_C)) {
            $domain = SplintrPhpSdk_Normalizer::normalize($domain, SplintrPhpSdk_Normalizer::FORM_C);
        }
    ...
    private static function validateLabel($label, Info $info, array $options, $canBeEmpty)
    {
        ...
        if (!SplintrPhpSdk_Normalizer::isNormalized($label, SplintrPhpSdk_Normalizer::FORM_C)) {
