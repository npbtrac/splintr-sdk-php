...
namespace Splintr\PhpSdk\Dependencies\GuzzleHttp\Psr7;

use Splintr\PhpSdk\Dependencies\Psr\Http\Message\RequestInterface;
use Splintr\PhpSdk\Dependencies\Psr\Http\Message\ServerRequestInterface;
...
final class Utils
{
     ...
     * - `Splintr\PhpSdk\Dependencies\Psr\Http\Message\StreamInterface`: Returns the value as-is.
